...
<div class="container">
  ...
  <form action="/reservation/save" method="post" name="saveform">
    <div id="CC">
      <div class="mt-5">
        <input type="date" class="datepicker form-control" placeholder="날짜를 선택해주세요." id="serviceDate" name="serviceDate">
          <script>
            ...
            $( function() {
              $( ".datepicker" ).datepicker({
                onChange: function() {
                 const date = $.datepicker.formatDate("yy-mm-dd",$(".datepicker").datepicker("getDate"));
...
<script>
  ...
  const qw = () => {
    ...
    input += "</textarea>"
    document.getElementById("detail").innerHTML = input;
  }
  const detail = () => {
    ...
    input +="</select>"
    document.getElementById("serviceCenter").innerHTML=input
  }
  const center = () => {
