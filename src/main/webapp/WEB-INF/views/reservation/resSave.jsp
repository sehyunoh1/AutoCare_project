...
<%--         <div id="CC">--%>
<%--             <div  class="mt-5">--%>
<%--                 <input class="datepicker form-control" placeholder="날짜를 선택해주세요." id="serviceDate" name="serviceDate">--%>
<%--                 <div id="date1">--%>
<%--                     <script>--%>
...
<%--             </div>--%>
<%--             <div>--%>
<%--                 <input type="hidden" value="${sessionScope.member.id}" name="memberId" >--%>
<%--             </div>--%>
...
<%--          </div>--%>
<%--         </div>--%>
<%--          <div name="subcategory" id="subcategorydiv" class="mt-5">--%>
<%--          </div>--%>
<%--          <div id="detaildiv" name="detail" class="mt-5">--%>
<%--          </div>--%>
<%--          <div id="serviceCenterdiv" name="serviceCenter" class="mt-5">--%>
<%--      </div>--%>
<%--          <div class="mt-4">--%>
...
<%--          input += "</select>"--%>
<%--        document.getElementById("subcategorydiv").innerHTML = input;--%>
<%--    }--%>
<%--    const ac = () => {--%>
<%--        let input = "<select class='form-select'   id='Subcategory' onchange='qw()'>"--%>
...
<%--        const subcategoryvalue = document.getElementById("subcategorydiv")--%>
<%--        subcategoryvalue.value = subvalue;--%>
<%--        console.log(subcategoryvalue);--%>

<%--        let input = "<textarea   id='detailarea' class='form-control' placeholder='100자 이내로 기입해주세요.' cols='30' row='100' onchange='detail()'>"--%>
<%--        input += "</textarea>"--%>
<%--        document.getElementById("detaildiv").innerHTML = input;--%>
<%--    }--%>
<%--    const detail = () => {--%>
<%--      const detailCk = document.getElementById("detailarea").value;--%>
<%--      const detail = document.getElementById("detaildiv")--%>
<%--        detail.value = detailCk;--%>
<%--      console.log(detail.value)--%>

<%--        let input = "<select class=form-select id='servicecenter' onchange=center() placeholder='서비스센터를 선택해주세요'>"--%>
<%--        input += "<option value=강남서비스센터>강남서비스센터</option>"--%>
<%--        input += "<option value=용산서비스센터>용산서비스센터</option>"--%>
<%--        input += "<option value=송도서비스센터>송도서비스센터</option>"--%>
<%--        input += "<option value=수원서비스센터>수원서비스센터</option>"--%>
<%--        input += "<option value=대전서비스센터>대전서비스센터</option>"--%>
<%--        input += "<option value=대전서비스센터>울산서비스센터</option>"--%>
<%--        input += "<option value=대전서비스센터>대구서비스센터</option>"--%>
<%--        input += "<option value=대전서비스센터>부산서비스센터</option>"--%>
<%--        input +="</select>"--%>
<%--        document.getElementById("serviceCenterdiv").innerHTML=input--%>
<%--    }--%>
<%--    const center = () => {--%>
<%--      const servicecenterCK = document.getElementById("servicecenter").value;--%>
<%--      const servicecenter = document.getElementById("serviceCenterdiv")--%>
